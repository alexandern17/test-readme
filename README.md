...
/
Pull requests
[THX-51754]-Update-README-with-interaction-map-details
feature/THX-51754-Update-documentation-for-codeless-interaction-map
develop
OPEN
Created 21 hours ago · Last updated 3 hours ago
...
Updated README with interaction map details

Is this a bug or feature?
[THX-51754] Documentation update
...
@@ -263,6 +264,14 @@ The framework listens to a number of UIViewController and UIView methods to prov
...
It looks like you don't have merge checks set up in your target branch yet.
...
3 of 6 builds failed
ONE SDK for iOS #1548
Ran 2646 test(s): 2641 passed, 5 failed
5 hours ago
ONE SDK for iOS 0.47.878 #878
Ran 30 test(s): 27 passed, 3 failed
5 hours ago
ONE SDK for iOS 0.47.3103 #3103
Ran 27 test(s): 26 passed, 1 failed
3 hours ago
ONE SDK for iOS 0.47.22 #22
Ran 32 test(s): 32 passed, 0 failed
4 hours ago
ONE SDK for iOS 0.47.23 #23
Ran 32 test(s): 32 passed, 0 failed
4 hours ago
ONE SDK for iOS 359 #359
Build passed in Nevercode
5 hours ago
...
Activity
Filter
Svetlana Khozin replied on GITHUB-README.md:42 [outdated]
1 more comment
Updated. Please review it again.

Svetlana Khozin · 5 hours ago
UPDATEDthe pull request with 1 commit: 9f3b255
Svetlana Khozin · 5 hours ago
commented on GITHUB-README.md:42 [outdated]
I believe this needs to be further up in the flow, as after we integrate the SDK we say everything is now working.

I believe this should not be under the list of programmatic methods as there’s nothing that can be done programmatically.

 

Andrei Pop · 12 hours ago
OPENEDthe pull request
Svetlana Khozin · 21 hours ago

Help and feedback
Care to share your thoughts about the new pull request experience?

Give feedback
Would you like to see this pull request in the old experience? View this pull request in the old experience
To go back to using the old pull request experience, go to Bitbucket Labs. For more details about the new pull request experience, see our help documentation. Learn more
